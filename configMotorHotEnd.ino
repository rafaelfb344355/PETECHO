...
// Defina os pinos para os botões 

const int btnUpPin = D1; 

const int btnDownPin = D2; 

const int btnLeftPin = D3; 

const int btnRightPin = D4; 
...
void loop() { 
 ...
 unsigned long currentMillis = millis();
  ...
  int buttonStateUp = digitalRead(btnUpPin); 
  ...
  int buttonStateDown = digitalRead(btnDownPin); 
  ...
  int buttonStateLeft = digitalRead(btnLeftPin); 
  ...
  int buttonStateRight = digitalRead(btnRightPin); 
